...
## Your first Keyblade
One of the key features of Kingdom Keys are the [[items/Keyblades\|Keyblades]] so you'll likely want to aim to get one first in order to get one you need the following:
